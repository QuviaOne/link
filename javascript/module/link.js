const quviaLink = {
    makeLink: (originalUrl, customLink, domain = "quvia.eu", validFrom = new Date(), validUntil = new Date(2030, 1), maxVisits = 100, length = 5) => {
        const body = {
            longUrl: originalUrl,
    ...
    uploadFile: (file, filename = file.name, status) => {
    ...
    sendHTTP: (endpoint, method = "GET", body, status, url = "https://link.quvia.cz/rest/v2/", headers = [
